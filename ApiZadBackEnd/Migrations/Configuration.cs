    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApiZadBackEnd.Models.ZadrugaEntities>
    {
        ...
        protected override void Seed(ApiZadBackEnd.Models.ZadrugaEntities context)
        {
            try
            {
                ...
                //      new sfDrzave() { DrzaveID = 1, Naziv = "SRBIJA", KodDrzave = "SRB", NameUser = "System", Opis = "prvi da vidim ide li", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 2, Naziv = "BOSNA I HERCEGOVINA", KodDrzave = "BIH", NameUser = "saska@saska.com", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 3, Naziv = "RUMUNIJA", KodDrzave = "ROM", NameUser = "radivoje@deretic.net", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 4, KodDrzave = "MNG", Naziv = "Crna Gora", Opis = "Provera", NameUser = "saska@saska.com", created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 5, KodDrzave = "SLK", Naziv = "Slovačka", Opis = "Provera opet", NameUser = "radivoje@deretic.net", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 6, KodDrzave = "JEM", Naziv = "JEMEN", NameUser = "radivoje@deretic.net", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 7, KodDrzave = "BEL", Naziv = "Belgija", Opis = "Opis kod insert sloga", NameUser = "saska@saska.com", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 8, KodDrzave = "POL", Naziv = "Poljska", Opis = "prvi put update, drugi put update", NameUser = "saska@saska.com", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 9, KodDrzave = "LTU", Naziv = "Litvanija", NameUser = "saska@saska.com", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 10, KodDrzave = "KNA", Naziv = "Sent Kits i Nevis", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 11, KodDrzave = "SWE", Naziv = "Švedska", EuClan = 1, NameUser = "saska@saska.com", created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 12, KodDrzave = "ESH", Naziv = "Zapadna sahara", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 13, KodDrzave = "JOR", Naziv = "Jordan", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 14, KodDrzave = "ZAF", Naziv = "Južnoafrička republika", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 15, KodDrzave = "HMD", Naziv = "Herd i MekDonald ostrva", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 16, KodDrzave = "SYR", Naziv = "Sirija", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 17, KodDrzave = "SXM", Naziv = "Sent Martin", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 18, KodDrzave = "PCN", Naziv = "Pitkern", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 19, KodDrzave = "LIE", Naziv = "Lihtenštajn", EuClan = 1, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 20, KodDrzave = "COM", Naziv = "Komorska ostrva", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 21, KodDrzave = "BRB", Naziv = "Barbados", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 22, KodDrzave = "HTI", Naziv = "Haiti", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 23, KodDrzave = "ALB", Naziv = "Albanija", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 24, KodDrzave = "COD", Naziv = "Kongo", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 25, KodDrzave = "MTQ", Naziv = "Matinik", EuClan = 0, created_at = DateTime.Now },
                //      new sfDrzave() { DrzaveID = 26, KodDrzave = "CYP", Naziv = "Kipar", EuClan = 1, NameUser = "saska@saska.com", created_at = DateTime.Now }
                //  );
        ...
        private static void DataPoPdvTab03(ZadrugaEntities context)
        {
            context.PoPdvTab03.AddOrUpdate(x => x.PoPdvTab03ID,
                new PoPdvTab03() { PoPdvTab03ID = 1, Oznaka = "3.1",
                    ...
                    BoldPozic = 0, OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0,
                    ObrPolje = 0,
                    NaslovPolje = 0,
                    UnosPolje = 1
                },
                ...
                new PoPdvTab03() { PoPdvTab03ID = 8, Oznaka = "3.8",
                    ...
                    BoldPozic = 1, OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0,
                    ObrPolje = 1,
                    NaslovPolje = 0,
                    UnosPolje = 0
                },
        ...
        private static void DataPoPdvTab03A(ZadrugaEntities context)
        {
            context.PoPdvTab03A.AddOrUpdate(x => x.PoPdvTab03AID,
             new PoPdvTab03A() { PoPdvTab03AID = 1, Oznaka = "3a.1",
                 ...
                 RedPrikaza = 1, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 2, Oznaka = "3a.2",
                 ...
                 RedPrikaza = 2, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 3, Oznaka = "3a.3",
                 ...
                 RedPrikaza = 3, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 4, Oznaka = "3a.4",
                 ...
                 RedPrikaza = 4, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 5, Oznaka = "3a.5",
                 ...
                 RedPrikaza = 5, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 6, Oznaka = "3a.6",
                 ParentDesc = "3а ОБРАЧУНАТИ ПДВ ЗА ПРОМЕТ ДРУГОГ ЛИЦА ",
                 Desc = @"ПДВ за промет добара и услуга без накнаде",
                 RedPrikaza = 6, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 7, Oznaka = "3a.7",
                 ParentDesc = "3а ОБРАЧУНАТИ ПДВ ЗА ПРОМЕТ ДРУГОГ ЛИЦА ",
                 Desc = @"Укупно обрачунати ПДВ за промет добара и услуга (3а.1+3а.2+3а.3+3а.4+3а.5+3а.6)",
                 RedPrikaza = 7, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab03A() { PoPdvTab03AID = 8, Oznaka = "3a.8",
                 ParentDesc = "3а ОБРАЧУНАТИ ПДВ ЗА ПРОМЕТ ДРУГОГ ЛИЦА ",
                 Desc = @"ПДВ пo основу накнаде или дела накнаде који је плаћен пре извршеног промета (аванс)",
                 RedPrikaza = 8, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 0, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 0,
                 NaslovPolje = 0,
                 UnosPolje = 1
             },
             new PoPdvTab03A() { PoPdvTab03AID = 9, Oznaka = "3a.9",
                 ParentDesc = "3а ОБРАЧУНАТИ ПДВ ЗА ПРОМЕТ ДРУГОГ ЛИЦА ",
                 Desc = @"Укупно обрачунати ПДВ (3а.7+3а.8)",
                 RedPrikaza = 9, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, OS_pdv = 0, PS_pdv = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             }
        ...
        private static void DataPoPdvTab05(ZadrugaEntities context)
        {
            context.PoPdvTab05.AddOrUpdate(x => x.PoPdvTab05ID,
             new PoPdvTab05() { PoPdvTab05ID = 1, Oznaka = "5.1",
                 ...
                 RedPrikaza = 1, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 2, Oznaka = "5.2",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 Desc = @"Укупно обрачунати ПДВ по општој стопи ПДВ (3.10+3а.9+4.1.4+4.2.4)",
                 RedPrikaza = 2, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 3, Oznaka = "5.3",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 ...
                 RedPrikaza = 3, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 4, Oznaka = "5.4",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 Desc = @"Укупан опорезиви промет добара и услуга по посебној стопи ПДВ (3.8+4.2.1)",
                 RedPrikaza = 4, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 5, Oznaka = "5.5",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 Desc = @"Укупно обрачунати ПДВ по посебној стопи ПДВ (3.10+3а.9+4.2.4)",
                 RedPrikaza = 5, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 6, Oznaka = "5.6",
                 Desc = @"Укупан промет добара и услуга (1.5+2.5+5.1+5.4)",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 RedPrikaza = 6, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             },
             new PoPdvTab05() { PoPdvTab05ID = 7, Oznaka = "5.7",
                 ParentDesc = "5. УКУПАН ПРОМЕТ ДОБАРА И УСЛУГА И УКУПНО ОБРАЧУНАТИ ПДВ",
                 Desc = @"Укупно обрачунати ПДВ (5.3+5.5)",
                 RedPrikaza = 7, KORISNIK_ID = 0, created_at = DateTime.Now, BoldPozic = 1, Iznos = 0,
                 ObrPolje = 1,
                 NaslovPolje = 0,
                 UnosPolje = 0
             }
        ...
        private static void DataPoPdvTab06(ZadrugaEntities context)
        {
          ...
          new PoPdvTab06() { PoPdvTab06ID = 1, Oznaka = "6.1",
              ...
              Desc = @"-",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 1, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 1,
              UnosPolje = 0
          },
          new PoPdvTab06() { PoPdvTab06ID = 2, Oznaka = "6.2",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"-",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 2, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 1,
              UnosPolje = 0
          },
          new PoPdvTab06() { PoPdvTab06ID = 3, Oznaka = "6.2.1",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"Основица за увоз добара ",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 3, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 0,
              UnosPolje = 1
          },
          new PoPdvTab06() { PoPdvTab06ID = 4, Oznaka = "6.2.2",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"Повећање основице за увоз добара ",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 4, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 0,
              UnosPolje = 1
          },
          new PoPdvTab06() { PoPdvTab06ID = 5, Oznaka = "6.2.3",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"Смањење основице за увоз добара ",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 5, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 0,
              UnosPolje = 1
          },
          new PoPdvTab06() { PoPdvTab06ID = 6, Oznaka = "6.3",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"Укупна вредност, односно основица за увоз добара (6.1+6.2.1+6.2.2+6.2.3) ",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 6, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 1,
              NaslovPolje = 0,
              UnosPolje = 0
          },
          new PoPdvTab06() { PoPdvTab06ID = 7, Oznaka = "6.4",
              ParentDesc = "6.2 Увоз добара на који се плаћа ПДВ",
              Desc = @"Укупан ПДВ плаћен при увоз добара, а који се може одбити као претходни порез ",
              Osnovica = 0, OS_osnov = 0, PS_osnov = 0, RedPrikaza = 7, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
              ObrPolje = 0,
              NaslovPolje = 0,
              UnosPolje = 1
          }
        ...
        private static void DataPoPdvTab07(ZadrugaEntities context)
        {
            ...
            new PoPdvTab07() { PoPdvTab07ID = 1, Oznaka = "7.1",
                ...
                Vrednost = 0, PdvNadoknada = 0, RedPrikaza = 1, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab07() { PoPdvTab07ID = 2, Oznaka = "7.2",
                ParentDesc = "7. НАБАВКА ДОБАРА И УСЛУГА ОД ПОЉОПРИВРЕДНИКА",
                Desc = @"Вредност плаћених добара и услуга ",
                Vrednost = 0, PdvNadoknada = 0, RedPrikaza = 2, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab07() { PoPdvTab07ID = 3, Oznaka = "7.3",
                ParentDesc = "7. НАБАВКА ДОБАРА И УСЛУГА ОД ПОЉОПРИВРЕДНИКА",
                Desc = @"Плаћена ПДВ надокнада ",
                Vrednost = 0, PdvNadoknada = 0, RedPrikaza = 3, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab07() { PoPdvTab07ID = 4, Oznaka = "7.4",
                ParentDesc = "7. НАБАВКА ДОБАРА И УСЛУГА ОД ПОЉОПРИВРЕДНИКА",
                Desc = @"Плаћена ПДВ надокнада која се може одбити као претходни порез ",
                Vrednost = 0, PdvNadoknada = 0, RedPrikaza = 4, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            }
        ...
        private static void DataPoPdvTab08(ZadrugaEntities context)
        {
            ...
            new PoPdvTab08() { PoPdvTab08ID = 1,
                ...
                Desc = @"-",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 1, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 2,
                Oznaka = "8a.1",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Први пренос права располагања на новоизграђеним грађевинским објектима ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 2, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 3,
                Oznaka = "8a.2",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Добра и услуге, осим добара из тачке 8а.1 ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 3, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 4,
                Oznaka = "8a.3",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Добра и услуге без накнаде",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 4, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 5,
                Oznaka = "8a.4",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Измена основице за набављена добра и услуге и исправка одбитка претходног пореза по основу измене основице - повећање",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 5, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 6,
                Oznaka = "8a.5",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Измена основице за набављена добра и услуге и исправка одбитка претходног пореза по основу измене основице - смањење",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 6, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 7,
                Oznaka = "8a.6",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Укупна основица за набављена добра и услуге (8а.1+8а.2+8а.3+8а.4+8а.5)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 7, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 8,
                Oznaka = "8a.7",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Накнада или део накнаде који је плаћен пре извршеног промета и ПДВ по том основу (аванс)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 8, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 9,
                Oznaka = "8a.8",
                ParentDesc = "8 а Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник испоручилац добара, односно пружалац услуга ",
                Desc = @"Укупно обрачунати ПДВ од стране обвезника ПДВ - претходног учесника у промету (8а.1+8а.2+8а.3+8а.4+8а.5+8а.7)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 9, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 10,
                Oznaka = "8б",
                ...
                Desc = @"-",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 10, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 11,
                Oznaka = "8б.1",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Пренос права располагања на грађевинским објектима ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 11, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 12,
                Oznaka = "8б.2",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Добра и услуге, осим добара из тачке 8б.1",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 12, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 13,
                Oznaka = "8б.3",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Добра и услуге без накнаде",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 13, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 14,
                Oznaka = "8б.4",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Измена основице за набављена добра и услуге - повећање ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 14, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 15,
                Oznaka = "8б.5",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Измена основице за набављена добра и услуге - смањење ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 15, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 16,
                Oznaka = "8б.6",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Укупна основица за набављена добра и услуге (8б.1+8б.2+8б.3+8б.4+8б.5)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 16, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 17,
                Oznaka = "8б.7",
                ParentDesc = "8 б Набавка добара и услуга у Републици од обвезника ПДВ - промет за који је порески дужник прималац добара, односно услуга ",
                Desc = @"Накнада или део накнаде који је плаћен пре извршеног промета (аванс)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 17, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 18,
                Oznaka = "8г",
                ...
                Desc = @"-",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 18, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 19,
                Oznaka = "8г.1",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Добра и услуге ",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 19, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 20,
                Oznaka = "8г.2",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Добра и услуге без накнаде",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 20, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 21,
                Oznaka = "8г.3",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Измена основице - повећање",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 21, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 22,
                Oznaka = "8г.4",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Измена основице - смањење",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 22, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 23,
                Oznaka = "8г.5",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Укупна основица за набављена добра и услуге (8г.1+8г.2+8г.3+8г.4)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 23, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 24,
                Oznaka = "8г.6",
                ParentDesc = "8 г Набавка добара и услуга у Републици од страних лица која нису обвезници ПДВ - промет за који постоји обавеза обрачунавања ПДВ",
                Desc = @"Накнада или део накнаде плаћен пре извршеног промета (аванс)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 24, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 25,
                Oznaka = "8д",
                ParentDesc = "8д Набавка добара и услуга, осим из тач. 8а до 8г",
                Desc = @"-",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 25, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 26,
                Oznaka = "8д.1",
                ParentDesc = "8д Набавка добара и услуга, осим из тач. 8а до 8г",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 26, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 27,
                Oznaka = "8д.2",
                ParentDesc = "8д Набавка добара и услуга, осим из тач. 8а до 8г",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 27, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 28,
                Oznaka = "8д.3",
                ParentDesc = "8д Набавка добара и услуга, осим из тач. 8а до 8г",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 28, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 29,
                Oznaka = "8ђ",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 29, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 30,
                Oznaka = "8е",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                Desc = @"-",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 30, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab08()
            {
                ...
                Oznaka = "8е.1",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                Desc = @"Укупно обрачунати ПДВ за промет набављених добара и услуга за који је порески дужник обвезник ПДВ - испоручилац добара, односно пружалац услуга, а који се може одбити као претходни порез (8а.8 умањен за износ ПДВ који се не може одбити као претходни порез)".Substring(0,240).Trim(),
                OS_osnov = 0,
                OS_pdv = 0,
                PS_osnov = 0,
                PS_pdv = 0,
            ...
            new PoPdvTab08()
            {
                ...
                Oznaka = "8е.2",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                Desc = @"Укупно обрачунати ПДВ за промет набављених добара и услуга за који је порески дужник обвезник ПДВ - прималац добара, односно услуга, а који се може одбити као претходни порез (3а.9 умањен за износ ПДВ који се не може одбити као претходни порез)".Substring(0,240).Trim(),
                OS_osnov = 0,
                OS_pdv = 0,
                PS_osnov = 0,
                PS_pdv = 0,
            ...
            new PoPdvTab08() { PoPdvTab08ID = 33, Oznaka = "8е.3",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 33, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 34, Oznaka = "8е.4",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                Desc = @"Исправка одбитка - смањење претходног пореза, осим по основу измене основице за промет добара и услуга",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 34, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab08() { PoPdvTab08ID = 35, Oznaka = "8е.5",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                Desc = @"Укупно обрачунати ПДВ за промет добара и услуга који се може одбити као претходни порез (8е.1+8е.2+8е.3+8е.4)",
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 35, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab08() { PoPdvTab08ID = 36, Oznaka = "8е.6",
                ParentDesc = "8е ПДВ ЗА ПРОМЕТ ДОБАРА И УСЛУГА КОЈИ СЕ МОЖЕ ОДБИТИ КАО ПРЕТХОДНИ ПОРЕЗ И ИСПРАВКЕ ОДБИТКА ПРЕТХОДНОГ ПОРЕЗА ",
                ...
                OS_osnov = 0, OS_pdv = 0, PS_osnov = 0, PS_pdv = 0, Naknada = 0, Iznos = 0,
                RedPrikaza = 36, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            }
        ...
        private static void DataPoPdvTab09(ZadrugaEntities context)
        {
            ...
            new PoPdvTab09() { PoPdvTab09ID = 1, Oznaka = "9",
                ...
                Iznos = 0, RedPrikaza = 1, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            },
            new PoPdvTab09() { PoPdvTab09ID = 2, Oznaka = "9а.",
                ParentDesc = "9а ПДВ КОЈИ СЕ У ПОРЕСКОЈ ПРИЈАВИ ИСКАЗУЈЕ КАО ПРЕТХОДНИ ПОРЕЗ ",
                Desc = @"-", Iznos = 0, RedPrikaza = 2, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 1,
                UnosPolje = 0
            },
            new PoPdvTab09() { PoPdvTab09ID = 3, Oznaka = "9а.1",
                ParentDesc = "9а ПДВ КОЈИ СЕ У ПОРЕСКОЈ ПРИЈАВИ ИСКАЗУЈЕ КАО ПРЕТХОДНИ ПОРЕЗ ",
                Desc = @"ПДВ плаћен при увозу добара ",
                Iznos = 0, RedPrikaza = 3, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab09() { PoPdvTab09ID = 4, Oznaka = "9а.2",
                ParentDesc = "9а ПДВ КОЈИ СЕ У ПОРЕСКОЈ ПРИЈАВИ ИСКАЗУЈЕ КАО ПРЕТХОДНИ ПОРЕЗ ",
                Desc = @"ПДВ надокнада плаћена пољопривреднику ",
                Iznos = 0, RedPrikaza = 4, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab09() { PoPdvTab09ID = 5, Oznaka = "9а.3",
                ParentDesc = "9а ПДВ КОЈИ СЕ У ПОРЕСКОЈ ПРИЈАВИ ИСКАЗУЈЕ КАО ПРЕТХОДНИ ПОРЕЗ ",
                Desc = @"ПДВ по основу набавки добара и услуга, осим из тач. 9а.1 и 9а.2 ",
                Iznos = 0, RedPrikaza = 5, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 0,
                NaslovPolje = 0,
                UnosPolje = 1
            },
            new PoPdvTab09() { PoPdvTab09ID = 6, Oznaka = "9а.4",
                ParentDesc = "9а ПДВ КОЈИ СЕ У ПОРЕСКОЈ ПРИЈАВИ ИСКАЗУЈЕ КАО ПРЕТХОДНИ ПОРЕЗ ",
                Desc = @"Укупан ПДВ који се у пореској пријави исказује као претходни порез (9а.1+9а.2+9а.3)",
                Iznos = 0, RedPrikaza = 6, BoldPozic = 1, created_at = DateTime.Now, KORISNIK_ID = 0,
                ObrPolje = 1,
                NaslovPolje = 0,
                UnosPolje = 0
            }
        ...
        private static void DataPoPdvTab10(ZadrugaEntities context)
        {
            context.PoPdvTab10.AddOrUpdate(x => x.PoPdvTab10ID,
              new PoPdvTab10() { PoPdvTab10ID = 1, Oznaka = "10",
        ...
        private static void DataPoPdvTab11(ZadrugaEntities context)
        {
            context.PoPdvTab11.AddOrUpdate(x => x.PoPdvTab11ID,
              new PoPdvTab11() { PoPdvTab11ID = 1, Oznaka = "11",
              ...
              new PoPdvTab11() { PoPdvTab11ID = 2, Oznaka = "11.1",
                  ParentDesc = "11. ПРОМЕТ ДОБАРА И УСЛУГА ИЗВРШЕН ВАН РЕПУБЛИКЕ И ДРУГИ ПРОМЕТ КОЈИ НЕ ПОДЛЕЖЕ ",
                  Desc = @"Промет добара и услуга извршен ван Републике ",
                  Iznos = 0, RedPrikaza = 2, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                  ObrPolje = 0,
                  NaslovPolje = 0,
                  UnosPolje = 1
              },
              new PoPdvTab11() { PoPdvTab11ID = 3, Oznaka = "11.2",
                  ParentDesc = "11. ПРОМЕТ ДОБАРА И УСЛУГА ИЗВРШЕН ВАН РЕПУБЛИКЕ И ДРУГИ ПРОМЕТ КОЈИ НЕ ПОДЛЕЖЕ ",
                  Desc = @"Пренос целокупне, односно дела имовине у складу са чланом 6. став 1. тачка 1) Закона",
                  Iznos = 0, RedPrikaza = 3, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                  ObrPolje = 0,
                  NaslovPolje = 0,
                  UnosPolje = 1
              },
              new PoPdvTab11() { PoPdvTab11ID = 4, Oznaka = "11.3",
                  ParentDesc = "11. ПРОМЕТ ДОБАРА И УСЛУГА ИЗВРШЕН ВАН РЕПУБЛИКЕ И ДРУГИ ПРОМЕТ КОЈИ НЕ ПОДЛЕЖЕ ",
                  Desc = @"Промет добара и услуга из члана 6. Закона, осим из тачке 11.2",
                  Iznos = 0, RedPrikaza = 4, BoldPozic = 0, created_at = DateTime.Now, KORISNIK_ID = 0,
                  ObrPolje = 0,
                  NaslovPolje = 0,
                  UnosPolje = 1
              }
